function renderCartItem(item) {
   ...
   itemCountText = itemCountText + ` × `; // 3. Присвойте переменной itemContText результат склеивания itemCountText и ` × `
   itemCountText = itemCountText + `product.price`; // 4. Присвойте переменной iutemCountText результат склеивания itemCountText и цены
